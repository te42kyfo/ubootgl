...
// During development, you can call ImGui::ShowTestWindow() in your code to
...
// Note that you can #define IMGUI_DISABLE_TEST_WINDOWS in imconfig.h for the
// same effect.
// If you want to link core ImGui in your public builds but not those test
// windows, #define IMGUI_DISABLE_TEST_WINDOWS in imconfig.h and those functions
// will be empty.
// For any other case, if you have ImGui available you probably want this to be
// available for reference and execution.
